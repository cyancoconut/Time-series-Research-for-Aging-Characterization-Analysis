function x_plot_ocv(varargin)
    ...
    variable_for_color = 'Capacity'; % 'Time', 'Current', 'Voltage', 'Temperature', 'EIS_Frequency', 'EIS_Z_abs', 'EIS_Z_phase', 'Ah_throughput', 'EIS_measurement_id'
    ...
    TT_ocv.Kraft( TT_ocv.Kraft > 10000) = NaN;
    TT_ocv.Kraft( TT_ocv.Kraft <200) = NaN;
    ...
    %                     check if subset is empty
                        ...
                        ylabel('Kraft in tbd','Interpreter','latex','FontSize',FontSizePlots,'fontname',FontNamePlots);
...
%                         set(gca, 'XDir','reverse');
    ...
    %                     ylim(ocv_y_lim);
                        ...
                        file_name = strcat(replace(cell_name," ","_"),"_dms");
